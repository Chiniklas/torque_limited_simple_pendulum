...
from software.python.simple_pendulum.controllers.TD3.TD3_controller import TD3Controller
...
# get the controller
model_path = "../../../data/models/TD3_model/TD3_3/TD3_1.8e6.zip"

controller = TD3Controller(model_path=model_path,
                           torque_limit=torque_limit,
                           use_symmetry=True,
