...
from software.python.simple_pendulum.reinforcement_learning.TD3.TD3 import td3_trainer

log_dir = "log_data/TD3_training"
...
trainer = td3_trainer(log_dir=log_dir)
...
trainer.init_agent(learning_rate=learning_rate,
                   warm_start=True,
                   warm_start_path="../../../data/models/best_model.zip",
                   verbose=1)
